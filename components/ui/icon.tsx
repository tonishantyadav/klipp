...
export const FireIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={cn('lucide lucide-flame', className)}
    >
...
export const UploadCloudIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn('lucide lucide-cloud-upload', className)}
    >
...
export const SquareMessageIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn('lucide lucide-message-square', className)}
    >
...
export const OpenIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn('lucide lucide-square-arrow-out-up-right', className)}
    >
...
export const FullScreenIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={cn('lucide lucide-fullscreen', className)}
    >
